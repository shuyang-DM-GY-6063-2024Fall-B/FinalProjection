...
//     if (touchingLine(player)) {
//       let centerX = width / 2;
//       let centerY = height / 2;
//       player.set(centerX, centerY);
//     }
//   }
...
//       if (nearestDoor) {
//         let index = doors.indexOf(nearestDoor);
//         if (index > -1) {
...
//       let dist = p5.Vector.dist(player, midPoint);
//       if (dist < minDist) {
//         minDist = dist;
//         nearestDoor = door;
//       }
...
//   function touchingLine(player) {
//     for (let line of walls.concat(doors)) {
//       let d = distToLine(player, line.start, line.end);
//       if (d < playerRadius) {
//         return true;
//       }
//     }
...
//     } else {
//       doors.push({start, end});
//     }
//   }

//   player = createVector(centerX, centerY);
// }
...
//   for (let door of doors) {
//     stroke(0, 255, 0); 
//     line(door.start.x, door.start.y, door.end.x, door.end.y);
//   }
